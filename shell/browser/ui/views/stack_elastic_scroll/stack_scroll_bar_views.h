...
#ifndef ELECTRON_SHELL_BROWSER_UI_VIEWS_STACK_ELASTIC_SCROLL_STACK_SCROLL_BAR_VIEWS_H_
#define ELECTRON_SHELL_BROWSER_UI_VIEWS_STACK_ELASTIC_SCROLL_STACK_SCROLL_BAR_VIEWS_H_
...
class StackScrollBarViews : public views::ScrollBarViews {
 ...
 private:
  std::unique_ptr<StackElasticScrollAnimator> animator_;
};

}  // namespace electron

#endif  // ELECTRON_SHELL_BROWSER_UI_VIEWS_STACK_ELASTIC_SCROLL_STACK_SCROLL_BAR_VIEWS_H_
