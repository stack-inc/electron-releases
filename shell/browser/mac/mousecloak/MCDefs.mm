...
#include "shell/browser/mac/mousecloak/MCDefs.h"

#import "shell/browser/mac/mousecloak/CGSInternal/CGSCursor.h"
...
NSDictionary *capeWithIdentifier(NSString *identifier) {
    ...
    CGError error = static_cast<CGError>(0);
...
//    }
    ...
    size_t size = 0;
    CGError err = static_cast<CGError>(0);
