...
void ScaledView::CreateScaledView() {
...
void ScaledView::SetZoomFactor(float factor) {
  //if (scaled_content_)
    //[(NSScaleRotateFlipView *) _rotationView setScale:factor];
}

float ScaledView::GetZoomFactor() const {
  //if (scaled_content_)
    //return [(NSScaleRotateFlipView *) _rotationView scale];
  return 1.0;
}
