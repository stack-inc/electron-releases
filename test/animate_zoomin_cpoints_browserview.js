...
function finishZoomOut(view) {
  ...
  if (anchorIndex < anchors.length) {
    view.setScale({"scaleX": 0.5, "scaleY": 0.5, "adjustFrame": true, "animation": {"duration": 5, "timingControlPoints": {"x1": 0.47, "y1": 0, "x2": 0.745, "y2": 0.715}}, "anchorX": anchors[anchorIndex]["posX"], "anchorY": anchors[anchorIndex]["posY"]})
