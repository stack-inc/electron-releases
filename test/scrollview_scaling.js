...
function addNextWebContentView(view, index) {
  addWebview(view, APPS[index], index);

  index++;
  if (index < APPS.length)
    setTimeout(addNextWebContentView, 2000, view, index)
}
...
function finishZoomIn(view) {
  ...
  setTimeout(addNextWebContentView, 2000, view, MIDDLE)
}
...
function createWindow () {
  ...
  setTimeout(startZoomIn, 5000, scrollContent)
}
